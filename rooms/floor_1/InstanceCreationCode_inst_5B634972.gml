t_scene_info = [
	[cutscene_change_xscale,obj_mimic2,0],
	[cutscene_wait,0.025],
	[cutscene_change_xscale,obj_mimic2,1],
	[cutscene_wait,0.025],
	[cutscene_change_xscale,obj_mimic2,0],
	[cutscene_wait,0.025],
	[cutscene_change_xscale,obj_mimic2,1],
	...
	[cutscene_wait,0.5],
	[cutscene_dialogue,["What was that?","player"]],
	[cutscene_change_xscale,obj_player],
	[cutscene_wait,0.5],
	[cutscene_change_xscale,obj_player],
	...
	[cutscene_wait,0.5],
	[cutscene_dialogue,["Freak! it's locked.","player",
	"Jordan said he has the key. I need to find him.","player"]],
	[cutscene_instance_create,616,472,"enemies",obj_mimic],
	[cutscene_lock_door,inst_433768DD],
	//[cutscene_lock_door,inst_4415C5CB],
	//[cutscene_lock_door,inst_55D3B500],
	[cutscene_change_value,obj_fade,"next_room",ending],
]