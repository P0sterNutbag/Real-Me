 if obj_progress.play_lobby_cutscene_1 {
	t_scene_info = [
		...
		[cutscene_instance_destroy,inst_7220377F],
		...
		[cutscene_wait,1],
		[cutscene_instance_create,280,190,"enemies",obj_mimic],
		[cutscene_play_animation,inst_54CCBD6E,spr_elevator,noone],
		[cutscene_change_value,inst_54CCBD6E,"close_timer",120],
